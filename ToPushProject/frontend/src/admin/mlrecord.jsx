...
const MlRecord = () => {
    ...
    useEffect(() => {
        const fetchRecords = async () => {
            try {
                const response = await axios.get('http://localhost:3000/api/v1/admins/login/records');
    ...
    const deleteRecord = async (id) => {
        try {
            await axios.delete(`http://localhost:3000/api/v1/admins/login/records/delete/${id}`);
