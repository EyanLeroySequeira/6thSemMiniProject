...
//             try {
//                 setLoading(true);
//                 const response = await axios.get(`http://localhost:3000/api/v1/doctors/${doctorId}`);
...
//             const doctorResponse = await axios.get(`http://localhost:3000/api/v1/doctors/${doctorId}`);
...
//             const userResponse = await axios.get(`http://localhost:3000/api/v1/users?name=${patientName}`);
...
//             await axios.patch(`http://localhost:3000/api/v1/doctors/${doctorId}`, {
...
//                     <NavLink to='/DoctorDashBoard' className="nav-link">Home</NavLink>
//                 </div>
//             </nav>
